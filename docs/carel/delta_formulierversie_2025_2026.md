...
(testaanvraag verzonden door de Atabix-formulierbeheerder, 21 juli 2026, zie ook `tmp/Re_ Xml.eml`).
**Bron oude versie:** referentiecapture 29 januari 2026 (intern gearchiveerd, git.sudwestfryslan.net - bevat persoonsgegevens, niet in deze publieke repo,
...
<FORMULIER>
  ...
  <ELEMENTEN>
    <form ...>
      <answers uniqueId="...">
        <globals>
          <bsn key="444555666">444555666</bsn>
          <stuf><geslachtsnaam key="">Jansen</geslachtsnaam> ...</stuf>
        </globals>
        <fleerlingenvervoerv3gegevensburger>
          <telefoonnummer key="">0612345678</telefoonnummer>
          <emailadres key="">voorbeeld@email.nl</emailadres>
          ...
        </fleerlingenvervoerv3gegevensburger>
        ...
      </answers>
...
<output>
  <transformedData>
    ...
    <element><name>bsn</name><value>444555666</value></element>
    <element><name>geslachtsnaam</name><value>Jansen</value></element>
    <element><name>telefoonnummer</name><value>0612345678</value></element>
    ...
  </transformedData>
</output>
```
...
- `aanvraagpdfdata` is in de nieuwe capture nog steeds een geldige, leesbare PDF (82.738 bytes,
  begint met `%PDF-1.7`).
- Testgegevens gebruiken hetzelfde BSN (444555666) en dezelfde naam (Jansen) als de oude
...
- Is deze exportvorm bewust gewijzigd door Atabix/Kodison, of is dit een fout in de nieuwe
  formulierversie? (navragen bij de Atabix-formulierbeheerder / leverancier)
