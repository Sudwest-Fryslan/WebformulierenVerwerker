...
- Huidig formulier: `docs/carel/20260302/Leerlingenvervoer.xml`
...
| Oud | Nieuw |
|-----|-------|
| `aanvrager_adres` = `"Snekerstraat"` (incompleet) | `aanvrager_straat` = `"Snekerstraat"` |
| — | `aanvrager_huisnummer` = `"30"` |
| — | `aanvrager_huisletter` = `""` |
| — | `aanvrager_huisnummertoevoeging` = `""` |
| `aanvrager_postcode` = `"8701XE"` | `aanvrager_postcode` = `"8701XE"` (behouden) |
| `aanvrager_plaats` = `"Bolsward"` | `aanvrager_woonplaats` = `"Bolsward"` (hernoemen) |
...
**Actie Atabix (Hein Vlietstra):** begintijd- en eindtijdveld toevoegen per dag, zichtbaar als de dag geselecteerd is.
...
> Veldnamen gemarkeerd met ⚠️ moeten worden bevestigd door Petra Schaap / CAReL-beheer voor de SWF-configuratie.
...
**Actie Atabix (Hein Vlietstra):** begintijd en eindtijd toevoegen per dag, zichtbaar als de dag geselecteerd is.
...
| # | Punt | Actie bij |
|---|------|-----------|
| 1 | Alle met ⚠️ gemarkeerde veldnamen bevestigen voor SWF-configuratie in CAReL | Petra Schaap / Eljakim |
| 2 | Geboorteplaats aanvrager: gemeentecode (`0091`) of plaatsnaam? | Eljakim / CAReL |
| 3 | Geboorteplaats leerling: veld toevoegen aan formulier | Hein Vlietstra / Atabix |
| 4 | Voorletters leerling: veld toevoegen aan formulier | Hein Vlietstra / Atabix |
| 5 | Leerlingadresvelden (6 stuks): conditioneel toevoegen aan formulier | Hein Vlietstra / Atabix |
| 6 | Begin/eindtijden per dag (10 stuks): toevoegen aan formulier | Hein Vlietstra / Atabix |
