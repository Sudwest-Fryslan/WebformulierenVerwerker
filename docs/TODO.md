...
**Update 22 juli 2026:** waarschijnlijk géén meerwerk — de Atabix-formulierbeheerder gebruikte voor deze test een eigen
...
**Update 22 juli 2026, later, definitief bevestigd:** een nieuwe testpoging van de Atabix-formulierbeheerder (met een aangepaste
...
echte formulierdata, alle door de mapping gebruikte paden resolven correct. Klaar om naar de Atabix-formulierbeheerder te
sturen.
...
**Update 22 juli 2026, bevestigd geslaagd door de Atabix-formulierbeheerder's eigen tests:** vier testaanvragen (13:34-14:24 uur)
...
Kodison. **Dit punt is afgerond.** Verplaatst naar "Afgehandeld" zodra de Atabix-formulierbeheerder dit ook zelf bevestigt.
...
is gebouwd en werkend getest, maar weer teruggedraaid op verzoek van de Solution Innovator (ontwikkelaar) — te veel eigen mechanisme
...
- **Fouten die de WSDL-validatie voorbij zijn** (getest: lege `aanvraagxmldata`, die lokaal al bij de
  ...
  vermoedelijk waarom de Atabix-formulierbeheerder op 22 juli geen HTTP-foutcode terugkreeg bij zijn mislukte test: de integratie
...
- **Inconsistente hoeveelheid detail:** in dat geval bevatte de faultstring een **volledige Java-stacktrace
  ...
  Atabix-integratie zelf (dezelfde plek waar de Atabix-formulierbeheerder de eerdere "No Error Info"-fout las) — geen burger of
