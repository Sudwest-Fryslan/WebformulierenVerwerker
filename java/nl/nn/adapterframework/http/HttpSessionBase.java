...
//		httpClientBuilder.disableAuthCaching();
	...
	protected HttpResponse execute(URI targetUri, HttpRequestBase httpRequestBase) throws IOException {
		return execute(null, targetUri, httpRequestBase);
	}

	protected HttpResponse execute(CloseableHttpClient httpClient, URI targetUri, HttpRequestBase httpRequestBase) throws IOException {
		if (httpClient == null) {
