		...
		Bedrijf:
			...
			-->
                        <bct:NameValue>
                            ...
                            <bct:Value><xsl:value-of select="$systemdate"/></bct:Value>
                        </bct:NameValue>
                        <bct:NameValue>
                            <bct:Name>poststuk.onderwerp</bct:Name>
                            <bct:Value><xsl:value-of select="//onderwerp"/></bct:Value>
                        </bct:NameValue>
                        <bct:NameValue>
                        ...
                        <bct:NameValue>
                            ...
                            <bct:Value><xsl:value-of select="//behandelaarnaam"/></bct:Value>
                        </bct:NameValue>
                        <bct:NameValue>
            ...
            -->
                        <bct:NameValue>
                            ...
                            <bct:Value><xsl:value-of select="translate($systemdate,'/','-')"/></bct:Value>
                        </bct:NameValue>
                        <bct:NameValue>
